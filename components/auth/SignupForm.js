...
import { Mail, Lock, User, Flame, AlertCircle } from 'lucide-react';
    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-left">
        ...
        <p className="text-[12px] text-[#678BA8] mt-6 mb-6 leading-tight text-center px-4">
          By continuing with sign up, you agree to our <Link href="/privacy" className="text-[#00D1A1] hover:underline">Privacy Policy</Link>, <Link href="/privacy#cookies" className="text-[#00D1A1] hover:underline">Cookie Policy</Link>, and <Link href="/terms" className="text-[#00D1A1] hover:underline">Member Agreement</Link>.
        </p>
