...
export function generateMetadata({ title, description, path = '', image, type = 'website', noindex = false }) {
  const fullTitle = title ? `${title} | ${APP_NAME}` : `${APP_NAME} - Discover What's Happening Around You`;
